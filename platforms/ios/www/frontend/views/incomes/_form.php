                        ...
                        <div class="col-lg-7">
                            <div class="p-5">
                                ...
                                <div class="row d-flex align-items-center justify-content-between">
                                    ...
                                    <div class="col"> 
                                        ...
                                        <?php  
                                            ...
                                            $incomeTypes = Typeincome::find()->where($condition)->all();

                                            // Create the array for Dropdown List
                                            $income_type = ArrayHelper::map($incomeTypes, 'type_name', 'type_name');
                                        ?>
                                ...
                                <div style="padding-left: 18%;">
                                    <?= Html::a('Customize', ['/typeincome/index'], ['class' => 'btn btn-user btn-block rounded-pill shadow-lg', 'style' => 'width: 65px; height: 25px; background-color: #FFA500; color: white;']) ?>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <?= $form->field($model, 'create_date')->widget(
                                        DatePicker::className(), [
                                            'options' => [
                                                ...
                                                'value' => date('Y-m-d'), // กำหนดวันที่ปัจจุบัน
                                            ],
                                            'clientOptions' => [
                                                'autoclose' => true,
                                                'format' => 'yyyy-mm-dd',
