...
<body style="background-color: #f8f9fa; font-size: 14px;">
    ...
    <center>
        <div style="margin-top: 15px;">
            <?= Html::a('Income', ['site/dayviewincome', 'date' => $date], ['class' => 'btn btn-info border font']); ?>
            <?= Html::a('Expense', ['/site/dayview'], ['class' => 'btn btn-light border font']); ?>
        </div>
    <br>
    <div class="card" style="width: 100%; ">
        <div class="container">
            ...
            $incomeDataProvider = new \yii\data\ActiveDataProvider([
                'query' => $incomesQuery,
